---
title: "Introduction"
description: "Copy-paste terminal UI components for React. Built on Ink and OpenTUI, powered by the termcn CLI."
---

**termcn** provides beautifully designed, accessible, and customizable terminal UI components. Built on [Ink](https://github.com/vadimdemedes/ink) and [OpenTUI](https://github.com/anomalyco/opentui), with a first-party CLI derived from the shadcn registry workflow.
...
<div className="not-prose grid gap-4 sm:grid-cols-2 mt-4">
  ...
  <FeatureCard
    icon={BlocksIcon}
    title="First-party CLI"
    description="Initialize projects and add components with npx termcn."
  />
</div>
