...
export const generateMetadata = async ({
  ...
  const content = getIntlayer("changelog-page", locale);

  return createPageMetadata({
    description: content.latestUpdatesDescription,
    ogType: "article",
...
export default async function ChangelogPage({
  ...
  const { locale } = await params;
  const content = useIntlayer("changelog-page", locale);
  const pages = getChangelogPages(locale);
