...
const SponsorPage = async ({
  ...
  const content = useIntlayer("sponsor-page", locale);

  const tierLabels: Record<string, ReactNode> = {
    Bronze: content.tierBronze,
    Gold: content.tierGold,
    Silver: content.tierSilver,
  };
    ...
    <DirectionalTransition>
      <section className="container-wrapper relative">
        <div className="container max-w-2xl flex flex-col items-center gap-4 py-16 text-center md:py-20 lg:py-24">
          <PageHero
            description={content.heroDescriptionPrimary}
