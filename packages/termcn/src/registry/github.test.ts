...
describe("GitHub registry items", () => {
  ...
  it("resolves explicit GitHub dependencies and keeps bare dependencies as termcn items", async () => {
    server.use(
      http.get(
        "https://raw.githubusercontent.com/acme/ui/1111111111111111111111111111111111111111/registry.json",
        () => {
      ...
      http.get("https://termcn.dev/r/index.json", () => {
        return HttpResponse.json([
          {
            name: "input",
            type: "registry:ui",
      ...
      http.get("https://termcn.dev/r/styles/new-york-v4/input.json", () => {
        return HttpResponse.json({
          name: "input",
          type: "registry:ui",
          files: [
  ...
  it("does not rewrite GitHub addresses as termcn registry items", () => {
