...
describe("resolveItemAddress", () => {
  it.each([
    ["button", { scheme: "termcn", item: "button" }],
    ["calendar", { scheme: "termcn", item: "calendar" }],
  ])("resolves termcn item address %s", (input, expected) => {
  ...
  it.each([
    ["foo/bar", { scheme: "termcn", item: "foo/bar" }],
    ["-owner/repo/button", { scheme: "termcn", item: "-owner/repo/button" }],
    ["owner-/repo/button", { scheme: "termcn", item: "owner-/repo/button" }],
    ["owner/./button", { scheme: "termcn", item: "owner/./button" }],
    ["owner/../button", { scheme: "termcn", item: "owner/../button" }],
    [
      "owner/repo with space/button",
      { scheme: "termcn", item: "owner/repo with space/button" },
    ],
  ])(
