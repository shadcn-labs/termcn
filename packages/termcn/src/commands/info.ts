...
const CODE_BASE = `${TERMCN_URL}/code/apps/v4/registry/bases`;
...
export async function collectInfo(
  ...
  return {
    ...
    components,
    links: {
      docs: `${TERMCN_URL}/docs`,
      components: `${TERMCN_URL}/docs/components/${base}/[component].md`,
      ui: `${CODE_BASE}/${base}/ui/[component].tsx`,
      examples: `${CODE_BASE}/${base}/examples/[component]-example.tsx`,
      schema: `${TERMCN_URL}/schema.json`,
    },
  };
}
...
export function printPresetInfo(
  ...
  if (!preset?.code) {
    ...
    printEntries({
      ...
      url: `${TERMCN_URL}/create?preset=${preset.code}`,
    });
