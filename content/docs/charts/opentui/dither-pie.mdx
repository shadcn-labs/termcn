...
<ComponentPreview base="opentui" name="dither-pie-chart-demo" hideCode />
...
```bash
npx shadcn@latest add @termcn/opentui/dither-pie-chart
```
...
/>
<ComponentSource
  src="registry/bases/opentui/lib/dither-pie-chart-utils.ts"
...
<ComponentPreview base="opentui" name="dither-pie-chart-variants" rows={23} />
